		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (controller instanceof UserMediaPageController) {
					((UserMediaPageController) controller).addToCart(singlePane.getData().getId(), singlePane.getData().getTitle(), singlePane.getData().getCost(), (int)spin.getValue(), ((PhysicalMedia)singlePane.getData()).getWeight());
				}
			}
		});
	}
