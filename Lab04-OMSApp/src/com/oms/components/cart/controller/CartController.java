...
public class CartController {
	...
	private String getPresentationText() {
		...
		return order.getCustomerName() + "'s cart has " + numberOfItems + " products. Total Cost: " + order.getTotalCost();
	}
	...
	public void addToCart(String productId, String productTitle, float productCost, int productQuantity, float weight) {
		order.addOrderLine(new OrderLine(productId, productTitle, productQuantity, productCost, weight));
	...
	public void checkOut() {
		...
		System.out.println(getPresentationText());
		updateCartPane();
	}
